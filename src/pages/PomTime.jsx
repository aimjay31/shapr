      ...
      <div className="pomtime-layout">
        ...
        <main className="pomtime-main">
          <div className="pomtime-main-card">
            <div className="pomtime-tabs" role="tablist" aria-label="Pomodoro Modes">
              <button
                type="button"
                className={`tab-btn ${mode === "focus" ? "active" : ""}`}
...
function SessionIcon() {
  return (
    <svg viewBox="0 0 24 24" className="pt-icon" fill="none">
      <path
        d="M4.75 6.25h9.5a1.5 1.5 0 0 1 1.5 1.5v8.5h-11a1.5 1.5 0 0 1-1.5-1.5v-7a1.5 1.5 0 0 1 1.5-1.5Z"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
      <path
        d="M15.75 9.25 20.25 7v10l-4.5-2.25"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinejoin="round"
      />
      <path
        d="M7 9.25h5.75M7 12h5.75M7 14.75h3.5"
        stroke="currentColor"
        strokeWidth="1.8"
        strokeLinecap="round"
      />
...
function CheckIcon() {
  return (
    <svg viewBox="0 0 24 24" className="pt-check-icon" fill="none">
      <path
        d="M6 12.5 10 16l8-9"
        stroke="currentColor"
        strokeWidth="2.4"
...
function ResetIcon() {
  return (
    <svg viewBox="0 0 24 24" className="pt-icon" fill="none">
      ...
      />
      <path
        d="M20 12a8 8 0 1 1-2.34-5.66L19 7.68"
        stroke="currentColor"
        strokeWidth="2"
        strokeLinecap="round"
        strokeLinejoin="round"
...
function PlayIcon() {
  return (
    <svg viewBox="0 0 24 24" className="pt-icon-lg" fill="currentColor">
...
function SkipIcon() {
  return (
    <svg viewBox="0 0 24 24" className="pt-icon" fill="currentColor">
      <path d="M6 6.2v11.6l8.2-5.8L6 6.2Z" />
      <rect x="15.6" y="6.2" width="2.4" height="11.6" rx="0.8" />
    </svg>
  );
}
...
function ChevronRightIcon() {
  return (
    <svg viewBox="0 0 24 24" className="pt-icon-sm" fill="none">
      <path
        d="m9 6 6 6-6 6"
        stroke="currentColor"
        strokeWidth="2.2"
