...
const historyData = [
  { id: 1, dateTime: "04/22/2024, 7:00 PM", subject: "English",  duration: "1 hr 10 mins", mood: "Focused",    sleepHrs: 6, result: "Productive"     },
  { id: 2, dateTime: "04/21/2024, 3:30 PM", subject: "Math",     duration: "45 mins",       mood: "Tired",      sleepHrs: 5, result: "Not Productive" },
  { id: 3, dateTime: "04/20/2024, 8:00 PM", subject: "History",  duration: "1 hr 30 mins",  mood: "Motivated",  sleepHrs: 7, result: "Productive"     },
  { id: 4, dateTime: "04/19/2024, 6:00 PM", subject: "Science",  duration: "1 hr 10 mins",  mood: "Focused",    sleepHrs: 7, result: "Productive"     },
  { id: 5, dateTime: "04/18/2024, 5:00 PM", subject: "Math",     duration: "1 hr 15 mins",  mood: "Focused",    sleepHrs: 6, result: "Productive"     },
  { id: 6, dateTime: "04/17/2024, 7:00 PM", subject: "English",  duration: "40 mins",       mood: "Distracted", sleepHrs: 3, result: "Not Productive" },
];
      ...
      <div className="history-card">
        ...
        <div className="history-controls">
          ...
          <div className="filter-wrapper">
            ...
            <svg className="chevron-icon" viewBox="0 0 24 24" fill="none" stroke="#6750A4" strokeWidth="2" strokeLinecap="round">
              <path d="M6 9l6 6 6-6" />
            </svg>
          </div>
        </div>
